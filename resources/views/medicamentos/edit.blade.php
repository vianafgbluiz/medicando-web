        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('medicamento.update', $medicamento) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-12 col-md-6 form-group">
                                        ...
                                        <input type="text" name="medic_nome" id="medic_nome" value="{{ $medicamento->medic_nome }}" placeholder="Nome do Medicamento" class="form-control" required/>
                                    </div>

                                    <div class="col-12 col-md-6 form-group">
                                        <label class="form-control-label" for="medic_preco">{{ __('Preço do Medicamento') }} <span style="color:red;">*</span></label>
                                        <input type="text" name="medic_preco" id="medic_preco" placeholder="Preço" value="{{ $medicamento->medic_preco }}" class="form-control" required/>
                                    </div>
                                </div>
                            </div>
